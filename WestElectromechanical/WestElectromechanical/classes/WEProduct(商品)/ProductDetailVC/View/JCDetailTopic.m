...
@implementation JCDetailTopic
@synthesize JCDetaildelegate;
...
-(void)click:(id)sender{
    [JCDetaildelegate didClick:[self.pics objectAtIndex:[sender tag]]];
}
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [JCDetaildelegate currentPage:currentPage total:[self.pics count]-2];
...
//    scrollTimer = [NSTimer scheduledTimerWithTimeInterval:0.0f target:self selector:@selector(scrollTopic) userInfo:nil repeats:YES];
}
