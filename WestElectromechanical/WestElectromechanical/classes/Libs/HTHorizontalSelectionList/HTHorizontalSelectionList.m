...
#define kHTHorizontalSelectionListInternalPadding ([UIScreen mainScreen].bounds.size.width)/9
#define kHTHorizontalSelectionListInternalPadding6 ([UIScreen mainScreen].bounds.size.width)/7
#define kHTHorizontalSelectionListInternalPadding6jia ([UIScreen mainScreen].bounds.size.width)/6.3
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _selectionIndicatorBar.backgroundColor = [UIColor lightGrayColor];
    ...
    for (NSInteger index = 0; index < totalButtons; index++) {
        ...
        if (previousButton) {
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[previousButton]-padding-[button]"
                                                                                     options:NSLayoutFormatDirectionLeadingToTrailing
                                                                                     metrics:@{@"padding" : @(
                                                                                                   IS_IPHONE_5||IS_IPHONE_4_OR_LESS?        kHTHorizontalSelectionListInternalPadding :( IS_IPHONE_6?kHTHorizontalSelectionListInternalPadding6: kHTHorizontalSelectionListInternalPadding6jia)   )
