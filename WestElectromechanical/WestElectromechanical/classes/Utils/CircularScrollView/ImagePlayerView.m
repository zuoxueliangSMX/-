...
- (void)_init
{
    ...
    // UIPageControl
    self.pageControl = [[SMPageControl alloc] initWithFrame:CGRectMake(0 ,self.frame.size.height-30, self.frame.size.width  , 20)];
//    self.pageControl.translatesAutoresizingMaskIntoConstraints = NO;
    self.pageControl.numberOfPages = self.count;
    self.pageControl.currentPage = 0;
    [self.pageControl setPageIndicatorImage:[UIImage imageNamed:@"appleDot"]];
    [self.pageControl setCurrentPageIndicatorImage:[UIImage imageNamed:@"currentAppleDot"]];
//    [self.pageControl setImage:[UIImage imageNamed:@"searchDot"] forPage:0];
